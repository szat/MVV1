...
void akaze_wrapper(float akaze_thresh, const cv::Mat& img_in, std::vector<cv::KeyPoint>& kpts_out, cv::Mat& desc_out);

void ratio_matcher_wrapper(const float ratio, const std::vector<cv::KeyPoint>& kpts1_in, const std::vector<cv::KeyPoint>& kpts2_in, const cv::Mat& desc1_in, const cv::Mat& desc2_in, std::vector<cv::KeyPoint>& kpts1_out, std::vector<cv::KeyPoint>& kpts2_out);
