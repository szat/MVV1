...
std::pair<int,int> synchronize_videos(std::string video_path_1, std::string video_path_2, int stop_frame);
...
std::pair<int, int> audio_sync(int initial_offset, float delay, int framerate);